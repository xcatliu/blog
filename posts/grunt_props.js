...
export default {
    ...
    'toc': React.createElement("aside", { dangerouslySetInnerHTML: {
            __html: '<nav class="toc"><ol><li><a href="#grunt-api">Grunt API</a><ol><li><a href="#gruntregistertask">grunt.registerTask</a></li><li><a href="#alias-task">Alias Task</a></li><li><a href="#function-task">Function Task</a></li><li><a href="#gruntregistermultitask">grunt.registerMultiTask</a></li><li><a href="#gruntconfig">grunt.config</a></li><li><a href="#gruntfile">grunt.file</a></li><li><a href="#gruntoption">grunt.option</a></li><li><a href="#thisoptions">this.options</a></li><li><a href="#thisfiles">this.files</a></li></ol></li><li><a href="#%E6%9C%80%E4%BD%B3%E5%AE%9E%E8%B7%B5">最佳实践</a></li></ol></nav>'
        } }),
    'author': "xcatliu",
    'contributors': [
        "xcatliu"
