...
const Posts = (props) => {
    ...
    return (React.createElement("section", { className: "main" },
        React.createElement("article", null, contentTitle !== null && contentTitle !== void 0 ? contentTitle : (title && React.createElement("h1", null, title)),
            React.createElement("ul", { className: "main_posts" }, blog === null || blog === void 0 ? void 0 : blog.posts.map(({ title, link, date, author, categories, excerpt, cover }) => (React.createElement("li", { key: link },
