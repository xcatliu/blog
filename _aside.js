    ...
    return (React.createElement("aside", null,
        ...
        React.createElement("ul", { className: "social" },
            Object.entries((_b = (_a = config.blog) === null || _a === void 0 ? void 0 : _a.social) !== null && _b !== void 0 ? _b : {}).map(([key, user]) => (React.createElement("li", { key: key, className: "flex_center" },
                React.createElement("a", { className: SOCIAL_MAP[key].icon, href: `${SOCIAL_MAP[key].linkPrefix}${user}`, target: "_blank", style: { backgroundImage: `url("${config.root}assets/${SOCIAL_MAP[key].icon}.svg")` } })))),
        ...
        React.createElement("nav", null,
            React.createElement("ul", { className: "menu" }, (_c = config.nav) === null || _c === void 0 ? void 0 : _c.map(({ text, link, icon, target }) => (React.createElement("li", { key: link },
